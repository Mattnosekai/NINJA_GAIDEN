...
declare sub SET_FULLSCREEN(xwidth1 as integer,ywidth1 as integer,cdepth1 as integer,wintitle as string)
...
declare sub LOAD_SPRITE_LEFT(varz as sprite,fname as string)
...
END SUB 
'===============================================================================
SUB SET_FULLSCREEN(xwidth1 as integer,ywidth1 as integer,cdepth1 as integer,wintitle as string)
'sets the screen to fullscreen
'sets screen resolution and color depth as well as the title bar of the window
s_xwidth=xwidth1
s_ywidth=ywidth1
s_cdepth=cdepth1
SCREENRES xwidth1,ywidth1,cdepth1,,GFX_FULLSCREEN
WindowTitle wintitle
setmouse 0,0,0 'hide the mouse pointer
END SUB 
'===============================================================================
...
varz.filename=fname
varz.spritebuf=ImageCreate(varz.xwidth, varz.ywidth, RGB(0, 0, 0) )
load_image varz.spritebuf,fname  
END SUB 
'===============================================================================
SUB LOAD_SPRITE_LEFT(varz as sprite,fname as string)
...
'nx=varz.xwidth
nx=0
varz.spritebuf=ImageCreate( varz.xwidth, varz.ywidth, RGB(255, 0, 255) )
dim tmpbuf as any ptr=ImageCreate( varz.xwidth, varz.ywidth, RGB(0, 0, 0) )
load_image tmpbuf,fname
DRAW_SPRITE varz.spritebuf,nx,0,varz.xwidth,varz.ywidth,tmpbuf,1,0
ImageDestroy tmpbuf
END SUB 
'=============================================================================== 
